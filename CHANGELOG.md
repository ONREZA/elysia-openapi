...
- Add `withContentType`, `withResponse`, and `withBinaryResponse` helpers for explicit response media types and response metadata.
- Add `withRequestContentType` for explicit request body media types.
